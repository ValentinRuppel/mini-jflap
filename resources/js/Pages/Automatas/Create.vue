    ...
    <div class="bg-white p-6 rounded shadow-md max-w-3xl mx-auto mt-6">
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mb-4">
                ...
                <input v-model="estadosTexto" type="text" class="border p-2 rounded w-full" placeholder="q0,q1,q2" />
            ...
            <div class="mb-4">
                ...
                <input v-model="alfabetoTexto" type="text" class="border p-2 rounded w-full" placeholder="0,1" />
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div v-for="simbolo in alfabeto" :key="simbolo" class="relative">
                                <div class="flex items-center gap-2 mb-1">
                                    <span class="font-mono font-bold bg-white border px-2 rounded text-sm">{{ simbolo
                                        }}</span>
                                ...
                                <div v-else class="relative">
                                    <button type="button" @click="toggleDropdown(estado, simbolo)"
                                        ...
                                        <span class="truncate block max-w-[120px]">
                                            {{ transiciones[estado][simbolo].length ?
                                    ...
                                    <div v-if="dropdownActivo === `${estado}-${simbolo}`"
                                        ...
                                        <label v-for="dest in estados" :key="dest"
                                            ...
                                            <input type="checkbox" :value="dest" v-model="transiciones[estado][simbolo]"
            ...
            <button type="submit" :disabled="form.processing"
                ...
                {{ form.processing ? 'Procesando...' : (isEditing ? 'Actualizar Autómata' : 'Guardar Autómata') }}
            </button>
...
const props = defineProps({
    automata: { // Prop opcional, si viene es EDICIÓN
        type: Object,
        default: null
    }
});

const isEditing = !!props.automata; // Boolean helper

// Variables reactivas (Inicializamos vacías o con los datos que vienen)
...
function submit() {
    ...
    if (isEditing) {
        form.put(route('automatas.update', props.automata.id));
    } else {
